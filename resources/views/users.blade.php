...
<body>
  ...
  <div class="container">
      <div class="row">
        <div class="col-8 mt-5">
          <form action="{{route('searchPartner')}}" method=get>
          @csrf
          ...
          <div class="main-button" class="float-end">
            @if(Auth::user())
              @if(Auth::user()->role == "admin")
                <a href="/addpartner" class="float-end">ADD</a>
              @endif
            @endif
          </div>
        </div>
  ...
  <div class="container mt-5">
    <div class="card mb-3" >
        <div class="row ">
          <div class="col-lg-3">
            <img src="{{asset(Storage::url($x->pic))}}" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-lg-9">
              <div class="card-body">
                ...
                <div class="col-lg-6">
                  <div class="main-button">
                    @if(Auth::user())
                      @if(Auth::user()->role == "admin")
                        <a href="/delpar/{{$x->id}}">DELETE</a>
                      @endif
                    @endif
                    @if(Auth::user())
                      @if(Auth::user()->role == "admin")
                        <a href="/editpartner/{{$x->id}}">edit</a>
                      @endif
                    @endif
                  </div>
                </div>
